...
REPO_SLUG = "AgentsFlix/skills"                                      # organização AgentsFlix desde 05/09/2026; jcarlosamorim/hermes-skills e AgentsFlix/hermes-skills redirecionam
WELLKNOWN = "https://agentsflix.github.io/skills"                    # host técnico: catálogo, .well-known, coláveis
